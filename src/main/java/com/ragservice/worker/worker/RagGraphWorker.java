...
import com.ragservice.worker.prompt.GraphPromptTexts;
...
import com.ragservice.worker.service.RagGraphExtractionClient;
...
public class RagGraphWorker extends AbstractRagStepWorker {
    ...
    private static boolean isTransient(Throwable e) {
        for (Throwable t = e; t != null; t = t.getCause()) {
            ...
            if (t instanceof com.ragservice.worker.error.exception.UpstreamErrorException up) {
