...
import com.ragservice.worker.dto.admin.DataSourceUpdateRequest;
...
public class AdminDataSourceController {
    ...
    public ResponseEntity<PagedResponse<DataSourceListItem>> list(
        ...
        com.ragservice.worker.domain.enums.UserType ut = resolveUserType(userType);
    ...
    private com.ragservice.worker.domain.enums.UserType resolveUserType(String raw) {
        if (raw == null || raw.isBlank()) return null;
        try {
            return com.ragservice.worker.domain.enums.UserType.valueOf(raw.trim().toLowerCase());
